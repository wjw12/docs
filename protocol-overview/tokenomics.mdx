...
**Phase 2**: (Completed. Rewards to be distributed in March 2025) 10M HEU airdropped to all miners at weekly snapshots. See [Season 2 (Ended)](/protocol-overview/mining/season-2)

**Phase 3**: (In Development) a dynamic amount of tokens (amount TBD) accumulated to all miners in a continuous stream.