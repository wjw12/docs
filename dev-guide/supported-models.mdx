...
### Large Language Models (LLMs)
  ...
  * `deepseek/deepseek-v3`: DeepSeek V3 is a powerful Mixture-of-Experts (MoE) language model with 671B total parameters, activating 37B parameters for each token. It achieves results comparable to Claude Sonnet 3.5.
