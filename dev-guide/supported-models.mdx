...
### Large Language Models (LLMs)
  * `DeepSeek/DeepSeek-R1`: A research-focused model with strong reasoning and problem-solving capabilities.
  * `DeepSeek/DeepSeek-Chat`: A conversational AI optimized for natural, multi-turn dialogues, excelling in reasoning and comprehension.
