...
description: "A wide range of AI models are supported. Besides vanilla LLMs and image generation models, we provide fine-tuned models customized for crypto use cases and Web3-native IPs. We also provide model fine-tuning service and private model deployment."
---

### Model List

Most supported models are open source. [View public models here](https://github.com/heurist-network/heurist-models/blob/main/models.json)
