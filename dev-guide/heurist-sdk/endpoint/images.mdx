---
title: "Images"
description: "Given a prompt and the model will generate a new image."
---
...
| prompt | `string` | false | The main cue information used to generate the image or iteration. |
