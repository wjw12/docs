...
Instead of a specific model ID, you can use any of the supported models from Heurist AI. You can find the complete list of available models in the official documentation: [Supported Models](https://docs.heurist.ai/supported_models).

## Authentication with API Key

To use the Heurist API, you need an API key, which authenticates your requests. The API key is required to interact with the service and access the models. To get your API key, follow the instructions in the Heurist API documentation.


```python
# Configure the OpenAI client
client = OpenAI(
    api_key="your_user_id#your_api_key",  # Replace with your actual API key
...
LLM_GATEWAY_URL = "https://llm-gateway.heurist.xyz"
model_id = ""
