...
We recommend visiting [Heurist Imagine](https://imagine.heurist.ai), go to individual model pages and see the example prompts of the models that you want to use.
