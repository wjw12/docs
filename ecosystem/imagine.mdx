...
We support Hunyuan video generation. The generation time is typically a few minutes. Video generation is also available for API access, see [Text-to-Video API documentation](../dev-guide/heurist-sdk/comfyui-txt2vid).
